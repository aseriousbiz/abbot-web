...
namespace Serious.Abbot.Migrations
{
    ...
    [Migration("20230801172214_RunRelatedEntities")]
    partial class RunRelatedEntities
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.AnnouncementCustomerSegment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("AnnouncementId", "CustomerTagId")
                        .IsUnique();

                    b.ToTable("AnnouncementCustomerSegments");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Conversation", b =>
                {
                    ...
                    b.Property<List<string>>("ThreadIds")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ThreadIds"), "GIN");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<CustomerProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.CustomerMetadataField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CustomerMetadataField");
                });

            modelBuilder.Entity("Serious.Abbot.Entities.CustomerTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<CustomerTagProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.CustomerTagAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Member", b =>
                {
                    ...
                    b.Property<MemberProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Organization", b =>
                {
                    ...
                    b.Property<OrganizationSettings>("Settings")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.PendingMemberNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PendingMemberNotifications");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Playbook", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<PlaybookProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.PlaybookRun", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<PlaybookRunProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<string>("SerializedDefinition")
                        .IsRequired()
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("PlaybookRuns");
                });

            modelBuilder.Entity("Serious.Abbot.Entities.PlaybookRunGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<PlaybookRunGroupProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("PlaybookRunGroups");
                });

            modelBuilder.Entity("Serious.Abbot.Entities.PlaybookVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<PlaybookVersionProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Room", b =>
                {
                    ...
                    b.Property<DateTime?>("DateManagedConversationsEnabledUtc")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("LastMessageActivityUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.SignalSubscription", b =>
                {
                    ...
                    b.Property<string>("ArgumentsPattern")
                        .HasColumnType("text");

                    b.Property<string>("ArgumentsPatternType")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Skill", b =>
                {
                    ...
                    b.Property<SkillProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.SkillExemplar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<ExemplarProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<TaskProperties>("Properties")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.ConversationClassifiedEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.ConversationEvent");

                    b.HasDiscriminator().HasValue("ConversationClassifiedEvent");
                });

            modelBuilder.Entity("Serious.Abbot.Entities.ConversationMatchedEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.ConversationEvent");

                    b.HasDiscriminator().HasValue("ConversationMatchedEvent");
                });

            modelBuilder.Entity("Serious.Abbot.Entities.ConversationSummarizedEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.ConversationEvent");

                    b.HasDiscriminator().HasValue("ConversationSummarizedEvent");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.NotificationEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.ConversationEvent");

                    b.HasDiscriminator().HasValue("NotificationEvent");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.PlaybookActionSkillRunEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.TriggerRunEvent");

                    b.ToTable("AuditEvents");

                    b.HasDiscriminator().HasValue("PlaybookActionSkillRunEvent");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.AnnouncementCustomerSegment", b =>
                {
                    ...
                    b.HasOne("Serious.Abbot.Entities.CustomerTag", "CustomerTag")
                        .WithMany()
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.CustomerMetadataField", b =>
                {
                    ...
                    b.HasOne("Serious.Abbot.Entities.Customer", "Customer")
                        .WithMany("Metadata")
                    ...
                    b.HasOne("Serious.Abbot.Entities.MetadataField", "MetadataField")
                        .WithMany("CustomerMetadataFields")
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.CustomerTagAssignment", b =>
                {
                    ...
                    b.HasOne("Serious.Abbot.Entities.CustomerTag", "Tag")
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Hub", b =>
                {
                    ...
                    b.HasOne("Serious.Abbot.Entities.Room", "Room")
                        .WithOne()
                        .HasForeignKey("Serious.Abbot.Entities.Hub", "RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.PlaybookRun", b =>
                {
                    b.HasOne("Serious.Abbot.Entities.PlaybookRunGroup", "Group")
                        .WithMany("Runs")
                        .HasForeignKey("GroupId");

                    b.HasOne("Serious.Abbot.Entities.Playbook", "Playbook")
                        .WithMany("Runs")
                        .HasForeignKey("PlaybookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Serious.Abbot.Entities.PlaybookRelatedEntities", "Related", b1 =>
                        {
                            b1.Property<int>("PlaybookRunId")
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("PlaybookRuns");

                            b1.HasOne("Serious.Abbot.Entities.Conversation", "Conversation")
                                .WithMany()
                                .HasForeignKey("ConversationId");

                            b1.HasOne("Serious.Abbot.Entities.Customer", "Customer")
                                .WithMany()
                                .HasForeignKey("CustomerId");
                            ...
                            b1.HasOne("Serious.Abbot.Entities.Room", "Room")
                                .WithMany()
                                .HasForeignKey("RoomId");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.TaskItem", b =>
                {
                    b.HasOne("Serious.Abbot.Entities.Member", "Assignee")
                        .WithMany()
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.MetadataField", b =>
                {
                    b.Navigation("CustomerMetadataFields");
