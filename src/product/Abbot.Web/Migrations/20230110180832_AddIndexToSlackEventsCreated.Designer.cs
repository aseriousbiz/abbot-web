...
namespace Serious.Abbot.Migrations
{
    ...
    [Migration("20230110180832_AddIndexToSlackEventsCreated")]
    partial class AddIndexToSlackEventsCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.AuditEvent", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("AuditEvent");
                });
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.AdminAuditEvent", b =>
                {
                    b.HasBaseType("Serious.Abbot.Entities.AuditEvent");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.AnnouncementEvent", b =>
                {
                    ...
                    b.Property<AnnouncementInfo>("AnnouncementInfo")
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.FormAuditEvent", b =>
                {
                    ...
                    b.Property<FormAuditEventProperties>("Properties")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.HubAuditEvent", b =>
                {
                    ...
                    b.Property<HubAuditEventProperties>("Properties")
                        .IsRequired()
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.SettingAuditEvent", b =>
                {
                    ...
                    b.Property<SettingAuditInfo>("SettingAuditInfo")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.InstallationEvent", b =>
                {
                    ...
                    b.Property<InstallationInfo>("InstallationInfo")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.RoomRespondersChangedEvent", b =>
                {
                    ...
                    b.Property<RespondersInfo>("ResponderChangeInfo")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.RoomResponseTimesChangedEvent", b =>
                {
                    ...
                    b.Property<ResponseTimeInfo>("ResponseTimeInfo")
                        .ValueGeneratedOnUpdateSometimes()
                        .HasColumnType("jsonb")
                        .HasColumnName("Properties");
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Member", b =>
                {
                    ...
                    b.OwnsOne("Serious.Abbot.Entities.WorkingHours", "WorkingHours", b1 =>
                        {
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Organization", b =>
                {
                    b.OwnsOne("Serious.Abbot.Entities.Threshold<System.TimeSpan>", "DefaultTimeToRespond", b1 =>
                        {
                            b1.Property<int>("OrganizationId")
                                .HasColumnType("integer");

                            b1.Property<TimeSpan?>("Critical")
            ...
            modelBuilder.Entity("Serious.Abbot.Entities.Room", b =>
                {
                    ...
                    b.OwnsOne("Serious.Abbot.Entities.Threshold<System.TimeSpan>", "TimeToRespond", b1 =>
                        {
